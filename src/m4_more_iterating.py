...
def run_test_sum_sequence():
    ...
    # ------------------------------------------------------------------
    # TO: 2. READ the COMMENTS and CODE in this function,
...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [9,88899778899,8,0,0,-36665476]
    threshold = -7
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [0,0.0,9.09889,-0,-8090.0000,0.000000001]
    threshold = 0
    expected = 2
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11
    sequence=[0.00000000000001,math.pi,02.0]
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 0
    actual = sum_first_n([-90,0,0,0,90,43], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
